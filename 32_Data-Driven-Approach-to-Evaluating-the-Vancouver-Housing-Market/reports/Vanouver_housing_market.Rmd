...
vancouver <- here::here("reports/figs/van-city.jpg")
knitr::include_graphics(vancouver)
```
...
```{r echo = FALSE, fig.align='center', out.width = "800px"}
vancouver_maps <- here::here("reports/figs/vancouver-map.png")
knitr::include_graphics(vancouver_maps)
```
...
grant_cardone <- here::here("reports/figs/grant-cardone.jpg")
